...
Main purpose:
- Run some cosanneal runs, compare 256 * 9 / 512 * 9 and the optimal hl that optuna found (512 + 256 * 8)

- lackadaisically set these to run before I went out for the day

Results:
- Bit disappointed with the results
- Will re-evaluate and setup a more purposeful iteration 37

**36.0: (training_data_14_20p)**
- hidden_layers: [512, 256, 256, 256, 256, 256, 256, 256, 256]
- epochs 150
- min_learning_rate: 0.0000000654
- start_learning_rate: 0.001227
- cosanneal

- 5.25 validation error

**36.2: (training_data_14_20p)**
...
- 4.36 validation error

**36.3: (training_data_14_20p)**
- hidden_layers: [512, 256, 256, 256, 256, 256, 256, 256, 256]
- 400 epochs
- min_learning_rate: 0.00000001
- start_learning_rate: 0.001
...
- 4.166 validation error

**36.4: (training_data_14_20p)**
- hidden_layers: [512, 512, 512, 512, 512, 512, 512, 512, 512]
- 400 epochs
- min_learning_rate: 0.00000001
- start_learning_rate: 0.001
- scheduler: cosanneal

- 46.658 validation error
